...
$INSTALL_DIR/venv/bin/pip install flask requests influxdb
...
# Aquí se copiarían los archivos de código fuente
# En lugar de eso, para este ejemplo, crearemos archivos de ejemplo
